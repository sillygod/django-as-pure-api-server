...
from rest_framework import (schemas, renderers, permissions, response)
...
# To check whether if we need to rewrite this or not.
...
generator = MySchemaGenerator(title='api doc', url='/api/', urlconf='api.urls')


@api_view()
@permission_classes((permissions.AllowAny, ))
@renderer_classes([
    renderers.CoreJSONRenderer, swagger_renderers.OpenAPIRenderer,
